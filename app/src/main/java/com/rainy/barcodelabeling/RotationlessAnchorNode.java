...
// Ar Anchor node that doesn't apply rotation on anchoring
public class RotationlessAnchorNode extends Node {
    private static final String TAG = RotationlessAnchorNode.class.getSimpleName();
    ...
    public RotationlessAnchorNode(Anchor anchor) {
        setAnchor(anchor);
    }
    ...
    private void updateTrackedPose(float deltaSeconds, boolean forceImmediate) {
        ...
        Vector3 desiredPosition = new Vector3(pose.tx(), pose.ty(), pose.tz());
